package com.example.homemade_guardian_beta.community;
...
public class CommunityUtil {                                                                                     // part18 :  중복되는 코드 빼기 (7'30")
    ...
    public static boolean isStorageUrl(String URL){ return Patterns.WEB_URL.matcher(URL).matches() && URL.contains("https://firebasestorage.googleapis.com/v0/b/homemade-guardian-beta.appspot.com/o/COMMUNITY"); }
