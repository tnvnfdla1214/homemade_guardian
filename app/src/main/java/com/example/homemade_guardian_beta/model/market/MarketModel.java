...
public class MarketModel implements Serializable {                                                         // part10 : 게시물 정보 (21'30") // part17 : Serializable(29')
    ...
    public MarketModel(String PostModel_Title, String PostModel_Text , Date PostModel_DateOfManufacture, String PostModel_Host_Uid, String PostModel_Post_Uid, String PostModel_Category, ArrayList<String> PostModel_LikeList, String PostModel_HotPost, String PostModel_reservation, String PostModel_deal){
        this.PostModel_Title = PostModel_Title;
        this.PostModel_Text = PostModel_Text;
        this.PostModel_DateOfManufacture = PostModel_DateOfManufacture;
        this.PostModel_Host_Uid = PostModel_Host_Uid;
