...
public class MarketModel implements Serializable {                                                         // part10 : 게시물 정보 (21'30") // part17 : Serializable(29')
    ...
    public Map<String, Object> getPostInfo(){
        ...
        docData.put("PostModel_Title", MarketModel_Title);
        docData.put("PostModel_Text", MarketModel_Text);
        docData.put("PostModel_ImageList", MarketModel_ImageList);
        docData.put("PostModel_Host_Uid", MarketModel_Host_Uid);
        docData.put("PostModel_DateOfManufacture", MarketModel_DateOfManufacture);
        docData.put("PostModel_Post_Uid", MarketModel_Post_Uid);
        docData.put("PostModel_Category", MarketModel_Category);
        docData.put("PostModel_LikeList", MarketModel_LikeList);
        docData.put("PostModel_HotPost", MarketModel_HotPost);
        docData.put("PostModel_reservation", MarketModel_reservation);
        docData.put("PostModel_deal", MarketModel_deal);
    ...
    public void setMarketModel_Title(String PostModel_Title){ this.MarketModel_Title = PostModel_Title; }
    public ArrayList<String> getMarketModel_ImageList(){
        return this.MarketModel_ImageList;
    }
    public void setMarketModel_ImageList(ArrayList<String> PostModel_ImageList){ this.MarketModel_ImageList = PostModel_ImageList; }
    public String getMarketModel_Host_Uid(){
        return this.MarketModel_Host_Uid;
    }
    public void setMarketModel_Host_Uid(String PostModel_Host_Uid){ this.MarketModel_Host_Uid = PostModel_Host_Uid; }
    public Date getMarketModel_DateOfManufacture(){
        return this.MarketModel_DateOfManufacture;
    }
    public void setMarketModel_DateOfManufacture(Date PostModel_DateOfManufacture){ this.MarketModel_DateOfManufacture = PostModel_DateOfManufacture; }
    public String getMarketModel_Post_Uid(){
        return this.MarketModel_Post_Uid;
    }
    public void setMarketModel_Post_Uid(String PostModel_Post_Uid){ this.MarketModel_Post_Uid = PostModel_Post_Uid; }
    ...
    public void setMarketModel_Category(String PostModel_Category){this.MarketModel_Category = PostModel_Category;}
    public ArrayList<String> getMarketModel_LikeList(){
        return this.MarketModel_LikeList;
    }
    public void setMarketModel_LikeList(ArrayList<String> PostModel_LikeList){ this.MarketModel_LikeList = PostModel_LikeList; }
    public String getMarketModel_HotPost(){
        return this.MarketModel_HotPost;
    }
    public void setMarketModel_HotPost(String PostModel_HotPost){ this.MarketModel_HotPost = PostModel_HotPost; }
    public String getMarketModel_reservation(){
        return this.MarketModel_reservation;
    }
    public void setMarketModel_reservation(String PostModel_reservation){ this.MarketModel_reservation = PostModel_reservation; }
    public String getMarketModel_deal(){
        return this.MarketModel_deal;
    }
    public void setMarketModel_deal(String PostModel_deal){ this.MarketModel_deal = PostModel_deal; }
}
