...
import com.example.homemade_guardian_beta.photo.common.ImageCaptureManager;
...
import static com.example.homemade_guardian_beta.photo.activity.PhotoPickerActivity.EXTRA_SHOW_GIF;
import static com.example.homemade_guardian_beta.photo.common.MediaStoreHelper.INDEX_ALL_PHOTOS;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == ImageCaptureManager.REQUEST_TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            if (DirectoryList.size() > 0) {
                ...
                DirectoryModel directory = DirectoryList.get(INDEX_ALL_PHOTOS);
                directory.getPhotoModelList().add(INDEX_ALL_PHOTOS, new PhotoModel(Path.hashCode(), Path));
